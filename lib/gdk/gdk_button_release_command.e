...
indexing
	...
	genesis: "199904300608 utc"
	version: "v 0.3.5 GTK+ 1.2.x"
	gtk_version: "1.2"
	cvs: "$Id: gdk_button_release_command.e,v 1.4 2000/07/10 02:01:26 richieb Exp $"

deferred class GDK_BUTTON_RELEASE_COMMAND
...
feature -- initialization
	...
	make_button_release (command_generator: GTK_OBJECT) is
		require
			valid_arg: command_generator /= Void
		do
			command_generator.add_action ("button_release_event", Current)
---		ensure
---			connected:
---				command_generator.action_by_name ("button_release_event") = Current
...
end -- GDK_BUTTON_RELEASE_COMMAND
